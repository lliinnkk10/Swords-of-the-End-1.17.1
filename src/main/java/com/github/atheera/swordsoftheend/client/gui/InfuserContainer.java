...
public class InfuserContainer extends AbstractContainerMenu {
    ...
    public InfuserContainer(int windowId, Level world, BlockPos pos, Inventory playerInventory, Player player) {
        super(ContainerInit.INFUSER_GENERATOR_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, BlockInit.BLOCK_ENCHANT_INFUSER_GENERATOR.get());
    }
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if(slot != null && slot.hasItem()) {
            ...
            if(index == 0) {
                ...
                if(SOTEHooks.getInfuserBurnTime(stack) > 0) {
