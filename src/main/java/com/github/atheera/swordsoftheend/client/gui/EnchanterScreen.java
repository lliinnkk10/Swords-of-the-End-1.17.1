...
public class EnchanterScreen extends AbstractContainerScreen<EnchanterContainer> {

    private ResourceLocation GUI = new ResourceLocation(SOTE.MOD_ID, "textures/gui/enchantment_infuser_gui.png");

    public EnchanterScreen(EnchanterContainer container, Inventory inv, Component component) {
